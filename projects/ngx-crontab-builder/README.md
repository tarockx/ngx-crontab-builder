...
NgxCrontabBuilder is an Angular control that allows users to visually edit a CRONTAB string in the Qaurtz format.

This project is an Angular port of my original [CrontabBuilder for WPF](https://github.com/tarockx/CrontabBuilder).

## Prerequisites
This component was developed using [PrimeNG](https://github.com/primefaces/primeng). Your project needs to include the `primeng`, `primeicons` and `primeflex` packages to work properly.
